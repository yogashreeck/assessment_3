...
document.getElementById('lblGreetings').innerHTML = "<br>"+greet +"<br>"+ 'User';
    ...
    var dt = new Date(); 
        ...
        document.getElementById('week').innerHTML = " <br>" + weekday[dt.getDay()] + "</b>";
   
   // to get date
   var a = new Date();
        var r = a.getDate();
        document.getElementById("date").innerHTML = r;
